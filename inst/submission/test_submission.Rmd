...
knitr::include_graphics(c("../plots/calplot_t.png", "../plots/calplot_a.png"))
```
...
knitr::include_graphics(c( "../plots/target_calplot_pre_snap.png", "../plots/target_calplot_calibrated.png"))
```
