...
These two models both perform quite well, and far better than random chance. The throw model accurately predicts 74% of all passes, with strong precision (84%) and recall (76%), while our AUC of 81% indicates strong calibration. As can be expected, our arrival model outperforms the throw model in all measures - accurately predicting 78% of all passes with a precision of 88%, a recall of 79%, and an AUC of 87%. Below are plots of the calibration of the predictions of each of the models on a held out data set.
